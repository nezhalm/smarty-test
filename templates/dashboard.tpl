  ...
  <div class="content-wrapper">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{$donnee.date_dernier_contact}</td>
            <td>{$donnee.telephone}</td>
            <td>{$donnee.historique}</td>
  <td>
                <a href="#" class="text-info" data-toggle="modal" data-target="#updateModal" 
                   data-id="{$donnee.id}" data-nom="{$donnee.nom}" data-prenom="{$donnee.prenom}" 
                   data-date_naissance="{$donnee.date_naissance}" data-sexe="{$donnee.sexe}" 
                   data-adresse="{$donnee.adresse}" data-telephone="{$donnee.telephone}" 
                   data-email="{$donnee.email}" data-date_enregistrement="{$donnee.date_enregistrement}" 
                   data-date_dernier_contact="{$donnee.date_dernier_contact}" 
                   data-historique="{$donnee.historique}" data-statut="{$donnee.statut}">
                    <i class="fas fa-edit"></i>
                </a>
             
              <a href="#" class="text-danger delete-item"    data-id="{$donnee.id}">
